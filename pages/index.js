        ...
        <Layout className="bgwhite">
          <div className="container">
            <div className="login-box">
              <Row>
                <Col xs={24} sm={24} md={24} lg={24} className="login-content left">
                    ...
                    >
                      <div className="vc_column-inner">
                        <div className="wpb_wrapper">
                          ...
                          >
                            <div className="wpb_wrapper">
                              <select id="ChoixDevis" onChange={(e) =>setIdCatPath(e.target.value)}>
                                {categories != null &&
                                  categories.map((secteur) => (
                                    <option value={"/devis/" + secteur._id} key={secteur._id}>
                          ...
                          <div className="w-btn-wrapper align_none">
                            ...
                            >
                              <a id="btnEstimation" href={idcatpath} onClick={selectedPath}>
                    ...
                    {categories != null &&
                      categories.map((secteur) => (
                        <Col
                          ...
                          key={secteur._id}
                        >
                          <Link href={"/devis/" + secteur._id} key={secteur._id}>
                            <a>
                              <img
                                src={secteur.image}
                                className="w100"
                    ...
                    <Col xs={24} sm={24} md={24} lg={8}>
                      <div>
                        ...
                        <p className="desc1 right">
                          ...
                          d&aposartisans certifiés dans toute la Côte d&aposivoire.
                        </p>
                      </div>
                    </Col>
